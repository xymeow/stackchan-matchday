...
[1.8.0](releases/1.8.0.md), [1.7.0](releases/1.7.0.md),
[1.6.0](releases/1.6.0.md), [1.5.0](releases/1.5.0.md), and
[1.4.0](releases/1.4.0.md) notes before rebuilding. The 1.7.0 multi-venue
aggregation is a watcher-only update; the 1.8.0 team-logo pack requires a
mod reflash. Spoiler protection on the
